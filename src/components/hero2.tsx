...
const About = () => {
  return (
    <section id="about" className="py-20 font-poppins">
      <h1 className='text-white text-6xl max-w-[320px] mx-auto font-semibold p-4 '>About <span className='text-[#D2B5A4]'>Me</span></h1>
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="flex flex-col md:flex-row gap-10 items-center">
          <div
            className="md:w-1/3"
          >
            <Image src={Chalu} alt="Chalu" className="w-full h-auto md:h-[400px] rounded-lg shadow-lg mx-auto" />

          </div>

          <div
            className="md:w-2/3 pl-10"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow">
                ...
                <h3 className="font-bold text-lg mb-2">College</h3>
                <p>B.Tech. in Computer Science, Lovely Professional University, 2022 - Present</p>
              </div>
              
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow">
                <Award className="text-primary-600 dark:text-primary-400 mb-3" size={28} />
                <h3 className="font-bold text-lg mb-2">Awards</h3>
                <p>Deans List Scholar, The Bronze Standard by IAYP,   </p>
              </div>
