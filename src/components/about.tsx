...
const about = () => {
    return (
      <div
        className="max-w-[1200px] mx-auto pb-24" id="about">

            

        <div className="grid grid-cols-8 gap-6 place-items-center max-md:flex max-md:flex-col max-md:p-6 pt-8 py-12">
            ...
            <div className='flex flex-row p-6'>
                ...
                <div className='flex flex-col mt-4'>
                    ...
                    <p className='text-lg text-white/70 mt-2'>I am pursuing a degree in Computer Science from <strong>Lovely Professional University</strong> and I am focused on technologies like <strong>React, Next.js, Tailwind CSS and Express Js along with Mongo DB</strong> for backend development.</p>
                </div>
            </div>
            </div>
